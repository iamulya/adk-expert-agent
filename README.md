...
* Gemini 2.5 Pro is being used as the model, so it can take good amount of time depending on the complexity of the queries, especially the ones that generate architectural diagrams, slides, pdf etc.
